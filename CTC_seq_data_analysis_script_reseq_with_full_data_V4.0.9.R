...
if (package.version("Seurat") != "4.3.0.1") {
...
DE_TreatmentCycles_2 <- FindMarkers(sct_CTC.obj, ident.1 = "1", ident.2 = "0")
...
geneName_matching_par(CON_Cluster_0v1, unif_gene_names, "ensembl_gene_id", "external_gene_name")
...
SPIA::plotP(x = SPIA_result, threshold = 0.05)
